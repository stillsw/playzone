...
/**
 * Android side version, class is identical to server-side version.
 * We have to have a copy rather than reference the same obj because the entities 
 * (eg Gift) on android are different objs to the server-side, owing
 * to javax.persistence not being available on Android.
 * 
 * @author xxx xxx
 *
 */
