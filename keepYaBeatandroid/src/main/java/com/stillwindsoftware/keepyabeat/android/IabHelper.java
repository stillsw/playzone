...
public class IabHelper {
    ...
    void logDebug(String msg) {
        if (mDebugLog) AndroidResourceManager.logd(mDebugTag, msg);
    }

    void logError(String msg) {
        AndroidResourceManager.loge(mDebugTag, "In-app billing error: " + msg);
    }

    void logWarn(String msg) {
        AndroidResourceManager.logw(mDebugTag, "In-app billing warning: " + msg);
    }
}
