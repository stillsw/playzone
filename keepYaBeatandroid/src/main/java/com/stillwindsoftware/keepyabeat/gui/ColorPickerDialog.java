...
/**
 * Thanks to JRowan for this code (see post : https://stackoverflow.com/questions/22724899/understanding-color-picker-dialog/22726100#22726100)
 * 
	...
	private class ColorPickerView extends View {
		...
		protected void onDraw(Canvas canvas) {
			...
			for (int x = 0; x < 256; x++) {
				...
				// canvas.drawLine(x + width/27, 0, x + width/27,height/8 ,
				// mPaint);
			}
			...
			for (int x = 0; x < 256; x++) {
				...
				// canvas.drawLine(x + width/27, height/8 + 10, x + width/27,
				// height*(5/6), mPaint);
			}
