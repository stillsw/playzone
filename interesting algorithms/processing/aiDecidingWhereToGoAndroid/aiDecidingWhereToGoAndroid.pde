...
static final int REQUEST_FPS = 60, GUI_SPACING = 50,
                 DRONES_MIN = 1, DRONES_MAX = 100, DRONE_W = 20, DRONE_H = 30, RANDOM_DRONE_CHANGE_DELAY = 30, GROUP_DRONE_CHANGE_DELAY = 21, 
...
volatile Drone[] drones;
volatile Attacker attacker;
LineVector2D[] wallLines = new LineVector2D[4];
volatile Planet[] planets;
...
int tick;
boolean drawSteering = false, hasWalls = true, wallFeelerBounceFront = true, hasAttacker = false, showAllEvasionDebugs, isPaused;
...
void setup() {
  ...
  quadsh = (displayHeight / QUAD_SIZE) * QUAD_SIZE; // truncates
  quadsw = (displayWidth / QUAD_SIZE) * QUAD_SIZE; 
...
//  println("quads w = "+quadsw+" h = "+quadsh);
  ...
  droneSpeedSlider = new Slider("Drone spd", DRONE_DEFAULT_SPEED_SLIDER, 0, 100, sx, sy, 300, 40, HORIZONTAL);
  ...
  sy -= GUI_SPACING;
  droneAlignmentSlider = new Slider("Drone algn", droneAlignment, 0, DRONE_MAX_GROUP_SETTINGS, sx, sy, 300, 40, HORIZONTAL);
  ...
  sy -= GUI_SPACING;
  droneCohesionSlider = new Slider("Drone cohs", droneCohesion, 0, DRONE_MAX_GROUP_SETTINGS, sx, sy, 300, 40, HORIZONTAL);
  ...
  sy -= GUI_SPACING;
  droneSeparationSlider = new Slider("Drone spc", droneSeparation, 0, DRONE_MAX_GROUP_SETTINGS, sx, sy, 300, 40, HORIZONTAL);
  ...
  sy -= GUI_SPACING;
  planetsSlider = new Slider("Planets", numPlanets, PLANETS_MIN, PLANETS_MAX, sx, sy, 300, 40, HORIZONTAL);
  planetsSlider.setInactiveColor(widgetFills);
  planetsSlider.setLineColor(WIDGET_LINES);

  sy -= GUI_SPACING;
  randomGoalOffsetSlider = new Slider("Rdm Offset", droneRandomGoalOffset, 0, DRONE_H * 5, sx, sy, 300, 40, HORIZONTAL);
  randomGoalOffsetSlider.setInactiveColor(widgetFills);
  randomGoalOffsetSlider.setLineColor(WIDGET_LINES);
  
  sy -= GUI_SPACING;
  dronesSlider = new Slider("Drones", DRONES_MIN, DRONES_MIN, DRONES_MAX, sx, sy, 300, 40, HORIZONTAL);
  ...
  sy -= GUI_SPACING;
  showAllEvasionDebugsToggle = new Toggle("                                                   All evasive debugs", sx, sy, 30, 30);
  ...
  sy -= GUI_SPACING;
  drawSteeringToggle = new Toggle("                                          Steering goal", sx, sy, 30, 30);
  ...
  sy -= GUI_SPACING;
  wallFeelerBounceFrontToggle = new Toggle("                                                                  Wall bounce (off = steer away)", sx, sy, 30, 30);
  ...
  sy -= GUI_SPACING;
  wallsToggle = new Toggle("                             Walls", sx, sy, 30, 30);
  ...
  sy -= GUI_SPACING;
  pauseToggle = new Toggle("                                Pause", sx, sy, 30, 30);
  ...
  sy -= GUI_SPACING;
  attackerToggle = new Toggle("                                  Attacker", sx, sy, 30, 30);
